    ...
    <div class="col-9">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 mb-3" style=" border-radius: 5px; background-color:var(--principal); width: 100%;">
                ...
                <a name="" id="button-add" class="btn" style="height: 100%; padding-left: 0;" style="padding-left: 0;" href="{{ route('painel.eventos.cadastrar') }}">
                                        ...
                                        <td>
                                            <div class="btn-group edit-table-button ">
                                                ...
                                                <div class="dropdown-menu" style="margin: 0px;">
                                                    <a class="dropdown-item" href="{{ route('painel.eventos.editar', ['evento' => $evento]) }}">Editar</a>
