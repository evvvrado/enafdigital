                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="categoria" required>
                                        @foreach (config('expositores.categorias_nome') as $codigo => $categoria)
                                            <option value="{{ $codigo }}"
                                                @if ($expositor->categoria == $codigo) selected @endif>{{ $categoria }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" name="email" type="text" placeholder="Insira o e-mail"
                                ...
                                <div
                                    ...
                                    <picture
                                        ...
                                        <img id="banner-preview"
                                            @if (!$expositor->foto) src="{{ asset('admin/images/thumb-padrao.png') }}" @else src="{{ asset($expositor->foto) }}" @endif
                                            style="height:
