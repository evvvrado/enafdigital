...
@section('titulo')
Projetos / <a style="color: unset" href="{{ route('painel.cursos') }}">Cursos</a> / Matrículas
@endsection
...
<div class="row">
    <div class="col-9">
        ...
        <div class="row"">
            ...
            <a name="" id="button-add" class="btn" " style=" opacity: 0; pointer-events: none;" href="{{ route('painel.cursos.cadastrar') }}">
                                    ...
                                    <td>
                                        <div class="btn-group edit-table-button ">
                                            ...
                                            <div class="dropdown-menu" style="margin: 0px;">
                                                <a class="dropdown-item text-danger" style="display: flex; align-items: center; gap: 5px;" href="">
                                                    <i class='bx bx-block text-danger'></i>
                                                    <span>Bloquear Matrícula</span>
                                                </a>
                                            </div>
                                        </div>
