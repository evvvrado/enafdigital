                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="row my-3">
                                <picture
                                    ...
                                    <img id="foto-preview"
                                        ...
                                        @if ($nova_imagem) src="{{ $nova_imagem->temporaryUrl() }}" @elseif($imagem) src="{{ asset($imagem) }}" @else src="{{ asset('admin/images/thumb-padrao.png') }}" @endif
                                        alt="">
                                </picture>
                            ...
                            <div class="mb-3">
                                ...
                                <input id="productname" name="nome" type="date" class="form-control contador"
                                    wire:model='inicio' required>
                                @error('inicio')
                                    <span class="error">{{ $message }}</span>
                                @enderror
                            </div>
