        ...
        <div class="container-fav">
            <div class="title">
                ...
                <div class="_filter">
                    <nav>
                        ...
                        <div class="_filterItem @if ($cont == 0) active @endif" data-filter="{{ date('dm', strtotime($curso->data)) }}">
            ...
            <div class="_cursosList">
                <div class="scroll">
                    ...
                    <div class="_curso {{ date('dm', strtotime($curso->data)) }}" onclick="window.location.href = '{{ route('site.curso', ['slug' => $curso->curso->slug]) }}'">
                        <div class="_pic">
    ...
    <section class="container-fluid s_embaixadores">
        <div class="container-fav">
            ...
            <div class="_pictures">
                ...
                <picture>
                    <img src="{{ asset($participante->foto) }}" onclick="window.open('{{ $participante->url }}')" title="{{ $participante->nome }}" alt="{{ $participante->nome }}" />
    ...
    <section class="container-fluid s_destaque reduzido">
        <div class="container-fav">
            <div class="_content fade">
                <div class="_line">
                    <button onclick="window.location.href = '{{ route('site.feira') }}'">
                ...
                <p>
                    O melhor do universo fitness para você a qualquer hora, em qualquer lugar... 24 horas por dia, 7 dias
                    por semana, 365 dias por ano conectados com você
                </p>
            </div>
        </div>
    </section>
