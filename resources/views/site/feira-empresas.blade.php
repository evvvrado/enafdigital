            ...
            @if ($anunciante)
                <div class="_box main">
                    <a href=" @if ($anunciante->expositor->hotsite &&
                        $anunciante->expositor->hotsite->slug){{ route('site.hotsite', ['slug' => $anunciante->expositor->hotsite->slug]) }}"
                ...
                <div class="_box">
                    <picture>
                        <a href=" @if ($expositor->hotsite &&
                            $expositor->hotsite->slug){{ route('site.hotsite', ['slug' => $expositor->hotsite->slug]) }}"
                            @else{{ $expositor->site }}
                            @endif">
                    ...
                    <li>
                        <a href="{{ $expositor->site }}">
                            ...
                            <main>
                                <legend>
                                    <div class="_icon">
                                        <img src="http://enafdigital.test/site/img/icon_call.svg"
