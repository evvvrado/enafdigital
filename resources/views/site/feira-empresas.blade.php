...
<body id="feiraEmpresas">
    ...
    <section class="container-fluid s_hero">
        <div class="container-fav">
            <h2 class="_h1">
                {{ $categorias[$expositor->categoria] }}
            </h2>
            <div class="_h1 fade">
        ...
        <section class="container-fluid s_empresas">
            <div class="container-fav">
                @if ($anunciante)
                    <div class="_box main">
                        <a
                            href=" @if ($anunciante->expositor->hotsite && $anunciante->expositor->hotsite->slug) {{ route('site.hotsite', ['slug' => $anunciante->expositor->hotsite->slug]) }} @else
                    {{ $anunciante->expositor->site }} @endif">
                        ...
                        <div>
                            ...
                            <span>
                                ...
                                <a href="{{ $anunciante->expositor->site }}" target="_blank">Baixar no Google
                                    Play</a>
                            </span>
                ...
                @foreach ($expositores->where('destaque', true) as $expositor)
                    <div class="_box">
                        <picture>
                            <a
                                href=" @if ($expositor->hotsite && $expositor->hotsite->slug) {{ route('site.hotsite', ['slug' => $expositor->hotsite->slug]) }}" @else {{ $expositor->site }} @endif">
                                ...
                                <li>
                                    <a href="{{ $expositor->site }}">
                                        <img style="display: unset;"
                                            src="{{ asset('/site/img/icon_googleplay.svg') }}" alt="Ícone">
                                    </a>
                                </li>

                                <li>
                                    <a href="{{ $expositor->email }}">
                                        <img style="display: unset;" src="{{ asset('/site/img/icon_appstore.svg') }}"
                                            alt="Ícone">
                                    </a>
                                </li>
                            </ul>
                    ...
                    {{ $anunciante->expositor->site }} @endif">
                        ...
                        <div>
                            ...
                            <span>
                                ...
                                <a href="{{ $anunciante->expositor->site }}"
                                    target="_blank">{{ $anunciante->expositor->site }}</a>
                            </span>
                            ...
                            <span>
                                ...
                                <a
                                    href="tel:{{ \App\Classes\Util::limparString($anunciante->expositor->telefone) }}">{{ $anunciante->expositor->telefone }}</a>
                            </span>
                            ...
                            <span>
                                ...
                                <a
                                    href="mail:{{ $anunciante->expositor->email }}">{{ $anunciante->expositor->email }}</a>
                            </span>
                        </div>
                    </div>
                @endif
