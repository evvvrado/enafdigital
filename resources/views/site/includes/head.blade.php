...
<head>
    ...
    <link rel="preload" href="{{ asset('/site/css/style.css') }}?v=2" as="style" />
    <link rel="preload" href="{{ asset('/site/js/jquery.min.js') }}?v=2" as="script" />
    <link rel="preload" href="{{ asset('/site/js/jquery-ui.js') }}?v=2" as="script" />
