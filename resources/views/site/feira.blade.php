            ...
            <div class="_a">
                <div class="_c2">
                    ...
                    <div class="_c">
                        ...
                        <svg class="desktop-style" style="margin-right: 7px" width="1215" height="1621" viewBox="0 0 1215 1621" fill="none" xmlns="http://www.w3.org/2000/svg">


                            <rect x="239" width="506" height="117" fill="#DEC300" onclick="window.location.href = '{{route('site.feiraEmpresas', 'metadologia-e-programas-de-treinamento')}}'" />
                            ...
                            <rect x="510" y="149" width="235" height="97" fill="#DEC300" onclick="window.location.href = '{{route('site.feiraEmpresas', 'anilhas-e-peso-livre')}}'" />
                            <rect x="508" y="271" width="235" height="91" fill="#DEC300" onclick="window.location.href = '{{route('site.feiraEmpresas', 'equipamento-articulado')}}'" />


                            <path d="M778.281 980H1013.28V1197.81H819.669L778.281 1159.84V980Z" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'arquitetura' )}}'" />


                            <path d="M743.457 1197.81L508.456 1197.81L508.456 1108.81L675.736 1108.81L743.457 1173.88V1197.81Z" fill="#08ADDA"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'radio-e-tv-online')}}'" />


                            <path d="M739 1073.98L508.46 1073.98L508.46 984.984L739 984.984L739 1028L739 1073.98Z" fill="#08ADDA"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'livraria')}}'" />

                            <rect x="1048" y="985" width="167" height="89" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'entidades-e-sindicatos')}}'" />

                            <rect x="1048" y="1105" width="167" height="89" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'entidades-bancarias')}}'" />

                            <rect x="1048" y="1232.63" width="166.892" height="171.473" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'adquirentes')}}'" />
                            ...
                            <path d="M1215 1577.3L1073.16 1440.06L1215 1440.06L1215 1577.3Z" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'bebedouros')}}'" />

                            <path d="M1048 1467L1208.84 1620.68H1048L1048 1467Z" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'gadget')}}'" />

                            <rect x="778" y="1552" width="235" height="69" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'comunicacao-visual')}}'" />

                            <rect x="778" y="1439" width="235" height="69" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'grafica')}}'" />

                            <rect x="508" y="1233" width="235" height="172" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'consultoria-juridica')}}'" />

                            <rect x="508" y="1440" width="235" height="181" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'universidades')}}'" />

                            <rect x="239" y="1552" width="235" height="69" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'corretora-de-seguros')}}'" />

                            <rect x="239" y="1442" width="235" height="69" fill="#08ADDA" onclick="window.location.href = '{{route('site.feiraEmpresas', 'convenios-e-planos-de-saude')}}'" />
                            ...
                            <path d="M0 396H204V570H0V396Z" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'confeccao-sportiva')}}'" />


                            <path d="M239.473 929H473.628V973.51L239.473 1289.36V929Z" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'produtos-naturais')}}'" />


                            <path d="M238.629 655L473.629 655L473.629 608.754L238.629 318.375L238.629 655Z" fill="#85C70B"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'suplementacao')}}'" />


                            <path d="M473.629 1294.54L278.895 1294.54L342.775 1208.29L473.628 1031.59L473.629 1294.54Z" fill="#08ADDA"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'corretora-de-seguros')}}'" />


                            <path d="M473.629 242.035L238.629 242.035V261.697L473.629 552.956L473.629 242.035Z" fill="#DEC300"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'lojas-de-sport')}}'" />


                            <path d="M0 242.035H179.24L203.569 273.376V363H0V242.035Z" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'equipamentos-cardio')}}'" />


                            <rect y="878.572" width="203.569" height="173.958" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'pisos-profissionais-e-grama')}}'" />


                            <rect y="1092.8" width="203.569" height="201.749" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'brindes-e-acessorios')}}'" />


                            <path d="M0 1328H204L155 1394H0V1328Z" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'climatizadores')}}'" />


                            <path d="M0.00604248 1449H131L0 1620.58L0.00604248 1449Z" fill="#85C70B" onclick="window.location.href = '{{route('site.feiraEmpresas', 'moveis-de-decoracao')}}'" />


                            <path d="M203.804 1620.58L38.5158 1619.35L128.155 1498.47L165.98 1447.53L203.805 1447.53L203.804 1620.58Z" fill="#08ADDA"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'area-kids')}}'" />


                            <rect x="1048.11" y="807.953" width="166.892" height="142.205" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'empresas-eventos')}}'" />


                            <rect x="1048.11" y="452.953" width="166.892" height="142.205" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'moda-vestuario')}}'" />


                            <rect x="1048.11" y="631" width="166.892" height="142.205" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'monitoramento')}}'" />


                            <rect x="1048" y="333" width="167" height="85" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'equipamentos-ar-livre')}}'" />


                            <rect x="779" y="808" width="235" height="142" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'franquias')}}'" />


                            <rect x="779" y="631" width="235" height="142" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'mentoria-e-consultoria-fitness')}}'" />


                            <path d="M1048.11 254.915L1215 29.2812V291H1048.11V254.915Z" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'manutencao-e-reforma')}}'" />


                            <path d="M956.032 379.189L1013.26 301.935L1013.61 596.096H795.668L956.032 379.189Z" fill="#1AC7D6"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'piscina')}}'" />


                            <rect x="508.121" y="395.562" width="235.001" height="200.535" fill="#DEC300" onclick="window.location.href = '{{route('site.feiraEmpresas', 'sistema-de-gestao')}}'" />


                            <path d="M536.172 630.922H726.635L656.047 726.321L635.594 753.996L536.172 630.922Z" fill="#DEC300"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'enaf-digital')}}'" />


                            <path d="M508.457 925.426L508.457 652.272L582.478 743.897L613.958 783.133L508.457 925.426Z" fill="#85C70B"
                                onclick="window.location.href = '{{route('site.feiraEmpresas', 'estetica')}}'" />


                            <path d="M778.184 394.82H900.946L844.589 472.94L778.184 560.365V394.82Z" fill="#DEC300" onclick="window.location.href = '{{route('site.feiraEmpresas', 'running')}}'" />


                            <path d="M526 950.158L743.458 667.881V950.158H560.489H526Z" fill="#1AC7D6" onclick="window.location.href = '{{route('site.feiraEmpresas', 'tecnologia')}}'" />
