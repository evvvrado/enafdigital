...
<body class="_carrinho">
    ...
    <header class="container-fluid">
        <div class="container-fav">
            <div class="_first">
                <div class="_logos">
                    <a href="{{ route('site.index') }}"><img src="{{ asset('site/img/_logo47_Color.png') }}"
                            alt="" /></a>
    ...
    <section class="container-fluid s_identificacao">
        <div class="container-fav"
            style="display: flex; gap: 5rem; align-content: space-between; justify-content: flex-start;">
            <div class="_half" style="justify-content: flex-start; width: 100%;">
                ...
                <div class="_top">
                    ...
                    <div class="_title _active">
                        ...
                        <h2><a
                                href="{{ route('site.carrinho-identificacao', ['curso' => $curso]) }}">Identificação</a>
                        </h2>
                    </div>
                                ...
                                action="{{ route('site.carrinho.finalizar.credito.gerencianet', ['curso' => $curso]) }}" @endif
                                    ...
                                    <label>
                                        ...
                                        <input required type="tel" inputmode="numeric" placeholder="0000 0000 0000 0000"
                                            pattern="[0-9\s]{13,19}" autocomplete="cc-number" name="numero"
                                            maxlength="19" />
                                    </label>
                                    <label>
                                    ...
                                    <div
                                        ...
                                        <label class="validade">
                                            <span>Validade</span>
                                            <input required type="tel" inputmode="numeric" name="expiracao"
                                        ...
                                        <label class="cvv ">
                                            ...
                                            <picture>
                                                <svg title="Informação fica atrás do cartão"
                                                    xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                                                    viewBox="0 0 24 24" style="fill: #11aacc;transform: ;msFilter:;">
                                                    <path
                                    ...
                                    <label class="parcelas">
                                        <span>Parcelas</span>
                                        <select style="padding: 0 0 0 2.7rem!important;" name="parcelas" id="parcelas"
                                            required>
                                            @for ($i = 1; $i <= $parcelas; $i++)
                                                <option value="{{ $i }}">{{ $i }}x -
                                                    R${{ number_format($curso->valor / $i, 2, ',', '.') }}</option>
                                            @endfor
                                        </select>
                                    </label>
                                    <div class="_cupom">
                                    ...
                                    <a class="changefom"
                                        href="{{ route('site.carrinho-efetuar', ['curso' => $curso]) }}">Trocar forma
                                        de pagamento</a>
                                </form>
                            </div>
                        @else
                                        ...
                                        <select style="padding: 0 0 0 2.7rem!important;" name="parcelas" required>
                                            @for ($i = 1; $curso->valor / $i > $configuracao->min_valor_parcela_boleto && $i <= $configuracao->max_parcelas_boleto; $i++)
                                                <option value="{{ $i }}">{{ $i }}x de
                                                    {{ number_format($curso->valor / $i, 2, ',', '.') }}</option>
                                            @endfor
                                        </select>
                                    </label>
                                    <div class="_cupom">
                    ...
                    checkout.getPaymentToken({
                        ...
                        function(error, response) {
                            if (error) {
                                ...
                                $("#div-erro h2").html(
                                    "Não foi possível validar o cartão. Por favor, verifique os dados e tente novamente."
                                )
                                $('#div-erro').attr('show', '')
